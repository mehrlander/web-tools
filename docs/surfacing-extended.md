...
* **Ask for a verdict 🕹️.** Surface an [approval request](https://github.com/mehrlander/web-tools/blob/main/docs/envelopes/approval.md) as `🕹️ [what is being decided](…/pages/approve.html#src=owner/repo[@ref]:approvals/<id>.request.json)`.
