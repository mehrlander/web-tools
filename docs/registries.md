...
one. It is a rule about *declaring* a registry you already have, not about
*needing* one, and the distinction has teeth: a registry beside data that already
exists is the duplication the integrity rule exists to prevent, and it will be
the copy that ages.
