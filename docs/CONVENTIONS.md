...
**Show pixels.** Chat displays sent images. If a visual change can be rendered in-session (headless browser, screenshot tool), send the screenshot instead of describing it, after looking at it yourself.
