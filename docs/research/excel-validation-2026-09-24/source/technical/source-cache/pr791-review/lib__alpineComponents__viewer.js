Warning: truncated output (original token count: 60430)
Total output lines: 4287
          ...
          const wireExtract = () => {
            ...
            box.addEventListener('click', (e) => {
              ...
              if (cell) {
                ...
                const kinds = picked.sheets.get(shee…430 tokens truncated….querySelector('[data-xs="ex-save"]').onclick = async () => {
              if (!built) return;
