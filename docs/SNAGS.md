...
**78 snags**, repeats first. Read this before adding one: a trip that is
...
| `link-sha-not-resolved` **×2** | 2026-09-01 | a commit SHA typed from memory, well-formed and pointing at nothing |
