...
8 by a skill, 29 by a page or component. The remaining 25 are
...
- [`workbook-extract.md`](envelopes/workbook-extract.md) *(orphan)* — the workbook-extract envelope contract: part of an .xlsx, picked along two axes
