...
- `courier/` — **courier** errand scripts, named by an errand's
  `run.script` with `run.method: courier-bookmark`, and run on that host through
  [`bookmarklets/courier-stage.js`](../bookmarklets/courier-stage.js). A console snippet is code
