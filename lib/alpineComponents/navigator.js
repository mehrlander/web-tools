document.addEventListener('alpine:init', function() {
  Alpine.data('navigator', function() {
    ...
    return {
          ...
          <div class="flex flex-col gap-1.5 border-t border-base-300 pt-2">
            ...
            <div class="flex items-center justify-between gap-2">
              <button @click="saveStage()" :disabled="savingStage"
                ...
                title="Write the staged list to .show-repo.json in this repo">
      ...
      // A repo's .show-repo.json can designate stage.files (a durable staged
      ...
      // else .show-repo.json already declares. Explicit gesture, one commit;
      ...
      async saveStage() {
        ...
        try {
          ...
          let cfg = {};
          try { cfg = JSON.parse((await this.gh.get('.show-repo.json')).text); } catch {}
          cfg.stage = { ...(cfg.stage || {}), files: [...this.pulled] };
          await this.gh.save('.show-repo.json', cfg, 'Update staged files via show-repo');
