          ...
          <div class="flex flex-col gap-0.5"
            ...
            <div data-top-section x-show="!loading"
              ...
              <div x-ref="topStrip" @scroll.passive="topScroll()"
                ...
                <!-- ══ Files ════════════════════════════════════════════════════ -->
                <div x-ref="files"
                     class="relative w-full min-w-full shrink-0 snap-center h-full flex flex-col gap-1.5 min-h-0">
              ...
              <div x-ref="fileList" x-show="!!listFiles.length && !filesLoading"
            ...
            <div x-ref="guide" x-show="hasGuide"
                 class="relative w-full min-w-full shrink-0 snap-center h-full flex flex-col gap-1 min-h-0">
