      ...
      template: `
        ...
        <div class="mx-auto w-full flex flex-col px-4 pt-2 pb-2 gap-0.5"
          ...
          <div class="flex flex-col gap-0.5"
               :class="framed ? 'flex-1 min-h-0 flex flex-col overflow-hidden pb-1'
                              : 'roomy:flex-1 roomy:min-h-0 flex flex-col'">
            ...
            <div x-show="!loading && reviewableFiles.length > 0"
                 class="mt-1 shrink-0 flex flex-col gap-0.5 h-[17rem] roomy:h-[22rem]">
             <!-- LOCKED, THE STRIP IS THE FIXED ONE and the guide takes the
                  ...
                  a box the strip has already spent. -->
