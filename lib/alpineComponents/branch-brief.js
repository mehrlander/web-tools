        ...
        <div class="mx-auto w-full flex flex-col px-4 pt-2 pb-2 gap-0.5"
          ...
          <div class="flex flex-col gap-0.5"
            ...
            <!-- 50/50 SPLIT: Top half (basis-1/2 max-h-[50%]) holding files and guide
                 ...
                 Structured as a rounded-box container with a curved header cap,
                 matching the reviewable cards below. -->
            <div data-top-section x-show="!loading"
                 ...
                 class="rounded-box border border-base-300 bg-base-100 overflow-hidden flex flex-col min-h-0"
                 :class="framed ? 'flex-1 min-h-0 basis-1/2 max-h-[50%]'
                                : 'roomy:min-h-0 roomy:flex-1 roomy:basis-1/2 roomy:max-h-[50%]'">
              <!-- Header cap with Files/Guide tabs and branch actions -->
            ...
            <!-- 50/50 SPLIT: Top half (basis-1/2 max-h-[50%]) holding files and guide
              ...
              <div x-ref="topStrip" @scroll.passive="topScroll()"
                   class="flex-1 min-h-0 shrink-0 items-stretch
                          flex items-start snap-x snap-mandatory
                          overflow-x-auto overflow-y-hidden overscroll-x-contain
                          [scrollbar-width:none] [&::-webkit-scrollbar]:hidden h-full">

                <!-- ══ Files ════════════════════════════════════════════════════ -->
                <div x-ref="files"
                     class="relative w-full min-w-full shrink-0 snap-center h-full flex flex-col min-h-0">
              ...
              <div x-ref="fileList" x-show="!!listFiles.length && !filesLoading"
                ...
                <div x-show="!!(verdict || scanLoading || scanError)"
                     class="sticky top-0 z-10 flex flex-wrap items-center gap-1.5 text-xs px-2.5 py-1.5
                            bg-base-200/90 backdrop-blur-sm border-b border-base-300">
