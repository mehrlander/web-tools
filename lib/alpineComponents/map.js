...
<!-- Say which axis this is. The badge on every row below is a KIND,
                          ...
                          <template x-for="g in c.segments" :key="g.label">
                            <div class="h-full"
                                 :class="[c.id === 'session_hook' ? 'bg-primary' : 'bg-secondary',
                                          ...
                                          injDup(g.path) && 'ring-2 ring-inset ring-[var(--color-warning)]/70']"
      ...
      TABS: [
        ...
        { k: 'harness', n: 'Harness', i: 'ph-wrench',
          g: 'Every executable the repository runs on itself, by the route execution arrives on: asked for, or fired by a git, session, plugin, or CI event.' },
