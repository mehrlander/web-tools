    ...
    return {
      ...
      template: `
        <div class="w-full">
          ...
          <!-- Purpose and Growth read Docs, and Tests is a kind of harness.
          ...
          <section x-show="mapTab==='docs'">
            <div class="flex items-center gap-2 mb-5 flex-wrap">
              ...
              <a :href="contextUrl" target="_blank" rel="noopener"
                ...
                <span>Session context</span><span aria-hidden="true">↗</span></a>
...
<!-- Say which axis this is. The badge on every row below is a KIND,
      ...
      SUBVIEW_PARENT: { aims: 'docs', growth: 'docs', tests: 'harness' },
