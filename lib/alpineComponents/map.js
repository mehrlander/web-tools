document.addEventListener('alpine:init', function() {
  Alpine.data('map', function() {
    ...
    // docs/CONSTELLATION.md), in ten top-level tabs. Docs carries Purpose,
    // Inventory, and Growth; Harness carries Automation and Tests.
      ...
      template: `
        <div class="w-full">
          ...
          <div class="flex items-center gap-0.5 rounded-lg bg-base-200/60 p-0.5 mb-4 w-fit flex-wrap" role="tablist">
            <!-- Docs opens on Purpose for a new reader; ?tab=docs remains
                 Inventory so saved links keep their exact destination. -->
            <template x-for="t in TABS" :key="t.k">
              <button role="tab" @click="setTab(t.k === 'docs' ? 'aims' : t.k)"
