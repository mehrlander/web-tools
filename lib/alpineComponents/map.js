document.addEventListener('alpine:init', function() {
  Alpine.data('map', function() {
    ...
    //               ALSO the only tab reading a second file: the doc-growth
    ...
    //               repeated statement's one authoritative file, its
    ...
    // FEDERATED, on the Growth tab's precedent: a repo declares a `checking`
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <div x-show="testExplain" class="text-sm text-base-content/40">
                    ...
                    <span x-show="testExplainChanged && testExplainChanged.size" class="text-warning"
                          x-text="' · ' + testExplainChanged.size + ' explained files changed since'"></span>
...
<!-- Say which axis this is. The badge on every row below is a KIND,
      ...
      init(){
        ...
        // The note kit. Every legend in these thirteen tabs is a note now, and
