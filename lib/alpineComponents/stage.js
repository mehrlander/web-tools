...
document.addEventListener('alpine:init', function() {
  Alpine.data('stager', function() {
    ...
    return {
      ...
      // the destination directory (the transfer drops staged files into it,
      // keeping their basenames); write the destSpec and close the picker. The
      // field stays editable, so a picked destination is a starting point.
      onDestPicked(sel) {
