        ...
        <div class="relative min-h-[55vh]"
              ...
              <div x-show="items.length" class="flex flex-col gap-2">
                ...
                <div class="flex items-center justify-between gap-2 border-b border-base-300 pb-2">
                  <div class="flex items-center gap-2 min-w-0">
                    ...
                    <span class="opacity-60 font-mono text-sm truncate"
          ...
          <div x-show="preview" x-cloak
            ...
            <div class="bg-base-100 border border-base-300 rounded-xl shadow-xl w-full max-w-3xl max-h-[80vh] flex flex-col overflow-hidden">
              <div class="px-3 py-2 bg-base-200/60 flex items-center gap-2 text-sm font-mono border-b border-base-300">
                ...
                <button @click="preview = null" class="btn btn-ghost btn-sm btn-square opacity-60 hover:opacity-100">
                  <i class="ph ph-x"></i>
                </button>
              </div>
              <div class="overflow-auto font-mono text-sm leading-snug p-3 whitespace-pre"
