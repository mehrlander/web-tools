    ...
    return {
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-col sm:flex-row gap-1.5">
                  <div class="flex items-center gap-1 flex-1 min-w-0">
                    ...
                    <select x-model.number="diffA" @change="_diffTouched = true" class="select select-xs select-bordered font-mono flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-1 flex-1 min-w-0">
                    ...
                    <select x-model.number="diffB" @change="_diffTouched = true" class="select select-xs select-bordered font-mono flex-1 min-w-0">
      ...
      init() {
        ...
        const autoPair = () => {
          ...
          if (this.items.length >= 2) this.diffB = this.items.length - 1;
        };
