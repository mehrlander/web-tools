        ...
        <div class="w-full flex flex-col gap-2.5 px-4 pt-3"
          ...
          <div x-show="branchChips.length"
            ...
            <i class="ph ph-git-branch text-sm text-base-content/40 shrink-0"
               title="Branches this session worked on"></i>
        ...
        for (const r of repos) {
          ...
          if (files.length > 0) {
            groups.push({
              ...
              branch: r.branch || '',
              files,
              branchUrl: r.branch ? `https://mehrlander.github.io/web-tools/pages/branch.html#gh=${encodeURIComponent(r.name)}@${encodeURIComponent(r.branch)}` : '',
            });
          }
        }
        ...
        for (const r of repos) {
          if (r?.name && r?.branch) {
            out.push({
              ...
              repo: r.name,
              branch: r.branch,
              url: `https://mehrlander.github.io/web-tools/pages/branch.html#gh=${encodeURIComponent(r.name)}@${encodeURIComponent(r.branch)}`,
            });
          }
        }
        return out;
