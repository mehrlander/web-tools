      ...
      template: `
        <div class="absolute inset-0 flex flex-col">
          ...
          <pre tabindex="0" @click="$el.focus()"
            ...
            class="flex-1 min-h-0 p-3 text-xs rounded-box bg-base-200 overflow-auto whitespace-pre-wrap break-all focus:outline-none focus:ring focus:ring-[var(--color-primary)]/30"
