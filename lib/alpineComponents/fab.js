  ...
  Alpine.data('fab', function() {
    return {
          ...
          <div x-init="_crumbD('d:body')"
            ...
            <div class="flex-1 min-h-0 flex flex-col overflow-hidden">
              ...
              <!-- TEXT. What the page SAYS, as against the four tabs about how
                   ...
                   without a model or network. Prior revisions and named files
                  ...
                  <div>
                    ...
                    <div class="border-b border-base-300/60">
                      <div class="flex items-center gap-2 px-2.5 pt-2 pb-0.5">
                        <div class="text-[12px] uppercase tracking-wider text-base-content/50 font-semibold">Prior revisions</div>
      ...
      _afterIdentityChange(was) {
        ...
        // identity strip changes while the figures and prior revisions remain
