  ...
  Alpine.data('fab', function() {
    return {
      ...
      async openPeek() {
        ...
        window.Peek.enable({ doc });
        this.open = false;
        this.outMsg = 'Peek on: tap anything, tap again for its parent';
      },
