                ...
                <template x-if="path">
                  <div class="p-2 flex flex-col gap-2 min-h-0 flex-1">
                    ...
                    <div class="min-h-0 flex-1 flex flex-col">
                      ...
                      <div x-show="branchNote" class="text-[10px] text-base-content/50 leading-snug mb-1 shrink-0" x-text="branchNote"></div>
                    ...
                    <button @click="renderAtRef()" class="btn btn-primary gap-1 w-full shrink-0"
                            :title="viaToss ? 'Re-address the tossed page at the selected ref, in place.'
                                            : 'Render this page at the selected ref in an overlay; its code loads from that ref (like ?use=).'">
                      <i class="ph ph-play"></i><span x-text="viaToss ? 'Re-toss at ref' : 'Use'"></span>
                    </button>
                    <template x-if="tossUrl">
                      <a :href="tossUrl" target="_blank" class="btn btn-ghost btn-sm gap-1 w-full shrink-0" title="Open a shareable toss-render link at this ref">
                        <i class="ph ph-disc"></i>Open in toss-render
                      </a>
                    </template>
