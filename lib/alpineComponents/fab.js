                ...
                <div x-show="pageActions.length" class="flex flex-wrap gap-1 mt-1.5">
                  <template x-for="(a, i) in pageActions" :key="i">
                    <button @click="runAction(a)" class="btn btn-xs gap-1" :title="a.label">
                      <i x-show="a.icon" class="ph text-sm" :class="a.icon"></i><span x-text="a.label"></span>
                    </button>
                  </template>
                </div>
              ...
              <div x-show="activeTab === 'render'">
                ...
                <template x-if="path">
                  <div class="p-2 flex flex-col gap-2">
                    ...
                    <button @click="renderAtRef()" class="btn btn-sm btn-primary gap-1 w-full">
                      <i class="ph ph-play"></i><span x-text="viaToss ? 'Re-toss at ref' : 'Render'"></span>
                    </button>
                    <template x-if="tossUrl">
                      <a :href="tossUrl" target="_blank" class="btn btn-sm btn-ghost gap-1 w-full">
