        ...
        <div class="border border-base-300 rounded-lg bg-base-100 overflow-hidden">
          ...
          <div x-show="open" x-collapse>
            <div class="border-t border-base-200 px-3 py-2 flex flex-col gap-2">
              ...
              <div x-show="error" class="alert alert-warning py-1 px-3 text-xs" x-text="error"></div>
              <div x-show="binary && !loading" class="text-xs opacity-60 italic">
              ...
              <div x-show="!loading && !binary && identical" class="text-xs opacity-60 italic">
        ...
        try {
          ...
          if (mine === this._renderSeq && this.$refs.cmhost) {
            this.$refs.cmhost.innerHTML =
              '<div class="p-3 text-xs opacity-60 italic">Diff view unavailable ('
