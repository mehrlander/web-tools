      ...
      template: `
        <div>
          <div class="flex items-center gap-2 mb-3">
            ...
            <span x-show="fromCache && !surveying" class="text-[11px] text-base-content/40 flex items-center gap-1"
            ...
            <div class="grow"></div>
            <button @click="reload()" :disabled="surveying || loading" class="btn btn-ghost btn-xs gap-1"
