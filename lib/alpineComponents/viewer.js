const ViewRegistry = {
  ...
  drawSheet(sheet, xl, key, opts) {
    ...
    const rules = [
      `.${uid}{border-collapse:separate;border-spacing:0;table-layout:fixed;font-size:14.7px;` +
        `font-family:Calibri,Aptos,'Segoe UI',system-ui,sans-serif;background:#fff;color:#000}`,
      `.${uid} td{border-right:1px solid #e3e3e3;border-bottom:1px solid #e3e3e3;padding:1px ${this.SHEET_PAD_X}px;` +
        `overflow:hidden;white-space:nowrap;vertical-align:bottom;line-height:1.2;text-align:left;box-sizing:border-box}`,
      `.${uid} td.n{text-align:right}`,
      `.${uid} th{background:#f0f0f0;border-right:1px solid #d4d4d4;border-bottom:1px solid #d4d4d4;` +
        `color:#444;font-weight:400;font-size:11px;font-family:'Segoe UI',system-ui,sans-serif;` +
        `text-align:center;position:sticky;box-sizing:border-box}`,
      `.${uid} thead th{top:0;height:20px;border-top:1px solid #d4d4d4;z-index:20}`,
      `.${uid} tbody th{left:0;width:${gutter}px;border-left:1px solid #d4d4d4;z-index:20}`,
      `.${uid} thead th:first-child{left:0;border-left:1px solid #d4d4d4;z-index:30}`,
      `.${uid} td.pvt-hdr{background:#c8e1ee!important;color:#000000!important;font-weight:600;border-color:#a8cee0!important}`,
      `.${uid} td.pvt-hdr a{color:#000000!important}`,
      `.${uid} td.tbl-hdr{font-weight:600;border:none;border-bottom:2px solid #000000}`,
      `.${uid} td.tbl-data, .${uid} td.tbl-stripe{border:none}`,
      `.${uid} td.pvt-subtotal{background:#daf0fa!important;font-weight:600}`,
      `.${uid} td.tbl-total, .${uid} td.pvt-grandtotal{font-weight:700!important;` +
        `border-top:1px solid #000!important;border-bottom:3px double #000!important}`,
