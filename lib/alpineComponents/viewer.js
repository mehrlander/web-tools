const ViewRegistry = {
    ...
    if (onThemeChange) {
      ...
      themeBox.innerHTML = `
        ...
        <select data-xl-theme class="select select-xs select-bordered py-0 h-6 min-h-0 text-xs">
          <option value="blue" selected>Office Blue</option>
        ...
        <input type="color" data-xl-color value="#104e70" title="Custom color" class="hidden w-5 h-5 p-0 border-0 rounded cursor-pointer">
      `;
  ...
  SHEET_THEMES: {
    blue:   { thBg: '#104e70', thText: '#ffffff', thBorder: '#0a354d', stripeBg: '#f2f7fa', subtotalBg: '#bce3f5', totalBorder: '#104e70' },
  ...
  drawSheet(sheet, xl, key, opts) {
    ...
    const rules = [
      ...
      `.${uid} td.tbl-hdr, .${uid} td.pvt-hdr{background:var(--xl-th-bg,#104e70)!important;` +
        `color:var(--xl-th-text,#ffffff)!important;font-weight:600;border-color:var(--xl-th-border,#0a354d)!important}`,
      `.${uid} td.tbl-hdr a, .${uid} td.pvt-hdr a{color:var(--xl-th-text,#ffffff)!important}`,
      `.${uid} td.tbl-stripe{background:var(--xl-stripe-bg,#f2f7fa)}`,
      `.${uid} td.pvt-subtotal{background:var(--xl-subtotal-bg,#bce3f5)!important;font-weight:600}`,
