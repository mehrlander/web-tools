      ...
      render: () => `<div class="flex flex-col h-full w-full">
        <div class="flex items-center gap-4 px-3 py-1.5 border-b border-base-300 bg-base-200/50 text-base shrink-0">
          <label class="flex items-center gap-1.5 cursor-pointer">
            <input type="checkbox" id="tab-header-filters" class="checkbox" checked>
      ...
      after: (f) => {
        requestAnimationFrame(() => {
          ...
          try {
            ...
            target.innerHTML = `<div class="p-4 text-error font-mono text-base">Invalid JSON Array for Table View</div>`;
          }
        });
      }
    },
        ...
        <div class="flex items-center justify-between mb-2 gap-2" x-show="file">
          ...
          <div class="flex items-center gap-0.5 shrink-0">
            <template x-for="u in fileUrls">
              <a :href="u.u" target="_blank" class="btn btn-square btn-ghost hover:text-primary">
