  ...
  modules: [
      ...
      render: () => `<div data-sheet="root" class="h-full w-full flex flex-col bg-base-200">
        <style>
          ...
          .xl-sheet-tab.btn-active {
            ...
            text-decoration: underline 2px solid var(--xl-tab-active-color, #107c41) !important;
            text-underline-offset: 3px !important;
            padding: 4px 8px 3px 8px !important;
            z-index: 2;
          }
        </style>
        <div data-sheet="tabs" class="hidden shrink-0 flex-wrap items-end gap-0.5 px-2 pt-1.5 pb-0 border-b border-[#d4d4d4] bg-[#f3f3f3]"></div>
    ...
    },
    {
      ...
      render: () => `<div data-xlsx="root" class="h-full w-full flex flex-col bg-base-200">
        <div data-xlsx="tabs" class="hidden shrink-0 flex-wrap items-end gap-0.5 px-2 pt-1.5 pb-0 border-b border-[#d4d4d4] bg-[#f3f3f3]"></div>
