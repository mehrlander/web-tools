      ...
      after: async (f, host) => {
        ...
        try {
          ...
          const table = (rows) => {
            ...
            return `<table class="table table-sm w-full">
          ...
          const sheetBlock = (sh) => `<div class="rounded border border-base-300 overflow-hidden">
            <button data-ex-sheetrow="${esc(sh.name)}"
                    class="w-full flex items-center gap-2 px-2 py-1 text-left bg-base-100 ${
          ...
          const extractSurface = () => {
            ...
            return `<div data-xs="ex" class="flex flex-col gap-3 p-3">
              <div class="flex flex-wrap items-center gap-2">
                <span data-xs="ex-fig" class="font-mono text-xs opacity-70 grow">${figures()}</span>
                <select data-xs="ex-cap" class="select select-xs select-bordered">
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="rounded border border-dashed border-base-300 overflow-hidden">
                  <div class="px-2 py-1 bg-base-100 flex items-center gap-2">
