            ...
            <div x-show="!previewOn" class="flex flex-wrap items-center gap-y-1.5 mb-2 shrink-0">
              ...
              <div class="flex items-center gap-2 ml-auto">
                ...
                <div class="join border border-base-300 overflow-hidden rounded-[var(--radius-field)]">
                  <button class="btn btn-xs join-item px-2 bg-base-100 hover:bg-base-200" aria-label="Table" data-note-bare data-note-look="plain"
                          data-note="Table: the rows in a sortable grid" @click="document.getElementById('tf-workbench').__viewer.switchMode('table')"><i class="ph ph-table text-sm"></i></button>
                  <button class="btn btn-xs join-item px-2 bg-base-100 hover:bg-base-200" aria-label="Editor" data-note-bare data-note-look="plain"
                          data-note="Editor: the rows as an editable JSON tree" @click="document.getElementById('tf-workbench').__viewer.switchMode('tree')"><i class="ph ph-tree-view text-sm"></i></button>
                  <button class="btn btn-xs join-item px-2 bg-base-100 hover:bg-base-200" aria-label="Raw" data-note-bare data-note-look="plain"
                          data-note="Raw: the rows as JSON text" @click="document.getElementById('tf-workbench').__viewer.switchMode('raw')"><i class="ph ph-text-t text-sm"></i></button>
                </div>
