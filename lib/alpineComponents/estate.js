        ...
        <div>
          ...
          <div x-show="tab==='surfaces'">
            ...
            <div class="flex items-center gap-2 mb-4" x-show="authed">
              <div x-show="surfaces.length > 1" role="tablist"
                ...
                <template x-for="(s, i) in surfaces" :key="s.file">
                  <button role="tab" @click="surfActive=i"
                          class="px-2.5 py-1 rounded-md text-base font-medium transition-colors whitespace-nowrap"
              ...
              <button @click="newSurface()"
                      class="btn btn-ghost gap-1.5 text-base-content/60 hover:text-primary border border-dashed border-base-300 shrink-0">
          ...
          <div x-show="tab==='activity'">
            <div class="flex items-center gap-2 mb-4" x-show="authed">
              ...
              <span x-show="openBranches.length" class="text-base font-mono text-base-content/40"
