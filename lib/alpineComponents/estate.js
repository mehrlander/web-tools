      ...
      template: `
        <div>
          ...
          <div x-show="tab==='repos'">
            <!-- No page title or prose: the header nav marks the active view.
                 A compact add control (authed) sits top-right; adding is now
                 per-category (the + on each group header prefills the group),
                 and this button adds without a preset group (a new category). -->
            <div class="flex items-center gap-2 mb-4" x-show="authed && !loading">
              <div class="grow"></div>
              <a href="https://github.com/mehrlander?tab=repositories" target="_blank"
                 class="text-base-content/30 hover:text-base-content/70 transition-colors" title="All repositories on GitHub">
                <i class="ph ph-github-logo text-base leading-none"></i></a>
              <button x-show="!addOpen" @click="openAdd('')"
              ...
              <section class="mb-8">
                <h2 x-show="sec.group" class="text-xs font-mono uppercase tracking-widest text-base-content/40 mb-3 flex items-center gap-2">
                  ...
                  <button x-show="authed" @click="openAdd(sec.group)"
                    ...
                    <i class="ph ph-plus text-sm leading-none"></i></button>
                </h2>
          ...
          <div x-show="tab==='surfaces'">
            ...
            <p x-show="!authed" class="text-sm text-base-content/60">
              Surfaces live in the private registry. Add a token with the shield in the header to see and edit them.
            </p>
