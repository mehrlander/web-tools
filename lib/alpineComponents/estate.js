        ...
        <div :class="tab==='lists' && 'flex-1 min-h-0 flex flex-col'">
          ...
          <div x-show="isActivityTab"
            ...
            <!-- ── The Activity query ──────────────────────────────────────
                 ...
                 last Tuesday's session only as a digit on the Week chip. So the
                 first character moves a windowed scope to All, and clearing the
                 box puts it back, unless the reader picked another scope
                 meanwhile. The chips still recount under the query.
