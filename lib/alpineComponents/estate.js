                ...
                <template x-for="e in row" :key="e.repo">
                  <div class="card bg-base-100 border border-base-300 shadow-sm hover:border-primary/40 transition-colors
                    ...
                    <div class="card-body p-4 gap-1.5">
                      ...
                      <!-- Nested companion repo (estate.nest): its three header
                           icons directly under the parent's three, and nothing
                           else. The lock leading where the globe sits above is
                           what says "the private counterpart"; it also opens
                           the repo here. Same sizes and tones as the parent's
