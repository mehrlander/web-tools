                ...
                <div class="rounded-lg border-l-4 pl-3 pr-3 py-2 transition-colors hover:brightness-[1.02]"
                  ...
                  <div class="flex items-center flex-wrap gap-x-3 gap-y-1 mt-1.5 text-sm">
                    ...
                    <span x-show="row.ahead !== null || row.behind !== null"
                          class="ml-auto flex items-center gap-2 font-mono tabular-nums"
                          :title="'commits ahead of / behind ' + row.def">
                      <span class="flex items-center gap-0.5" :class="row.ahead ? 'text-success' : 'text-base-content/40'">
                        <i class="ph ph-arrow-up text-sm"></i><span x-text="row.ahead ?? '–'"></span></span>
                      <span class="flex items-center gap-0.5 text-base-content/40">
                        <i class="ph ph-arrow-down text-sm"></i><span x-text="row.behind ?? '–'"></span></span>
                    </span>
                  </div>
                </div>
              </template>
