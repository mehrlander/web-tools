...
${opts.nested ? '' : `
    ...
    return {
      ...
      repoIconCell(text){
        ...
        return '<span class="flex items-center gap-1.5 overflow-hidden">'
          + shown.map(r => '<i class="ph shrink-0 text-base leading-none text-info '
              + window.esc(this.repoIcon(r)) + '" data-note="' + window.esc(r) + '"></i>').join('')
      ...
      get tableColumns(){
        ...
        const dateCol = { title: 'Last', field: 'at', width: 100, headerFilter: 'input',
        ...
        if (G === 'branch') {
          return [
            { title: 'Repo', field: 'repo', width: 72, headerFilter: 'list',
              ...
              formatter: (c) => this.repoIconCell(c.getValue()), dflt: true },
        ...
        return [
          ...
          this.nameColumn(),
          { ...dateCol, dflt: true },
          { ...this.NUM_FILTER, title: 'Ran', field: 'mins', sorter: 'number', width: 72,
          ...
          // off the right edge on a 1500px screen. 128 is four glyphs plus the
          // overflow counter; it was 300 while this column held name pills.
          { title: 'Repos', field: 'repos', width: 128, headerFilter: 'input',
            formatter: (c) => this.repoIconCell(c.getValue()), dflt: true },
          ...
          num('Failed', 'failures', { dflt: true, width: 72,
            formatter: (c) => c.getValue()
      ...
      stateColumn(){
        return { title: 'State', field: 'state', width: 64, headerFilter: 'list',
          headerFilterParams: { valuesLookup: true, clearable: true },
          hozAlign: 'center',
          formatter: (c) => {
