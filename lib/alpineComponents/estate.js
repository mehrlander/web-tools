              ...
              <template x-for="n in sessionNodes" :key="n.key">
                ...
                <div x-data="{ get row(){ return n.row } }">
                  ...
                  <div class="flex items-center flex-wrap gap-x-4 gap-y-1.5 mt-2 text-base">
                    ...
                    <!-- Agents dispatched, shown only when there were any: 27
                         of 341 records on file, so an always-present zero
                         would cost every row a column to say nothing. The
                         count is the point rather than a badge, since the
                         range runs 1 to 160 and those are different sessions.
                         No :title, unlike its neighbours: the hover card is
                         the built version of that tooltip and reaches a phone,
