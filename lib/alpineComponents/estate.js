        ...
        <div>
          ...
          <div x-show="tab==='activity'">
            <div class="flex items-center gap-2 mb-3" x-show="authed">
              ...
              <span x-show="activityGeneratedAt" class="hidden sm:inline text-xs text-base-content/55" x-text="'as of ' + agoOf(activityGeneratedAt)"></span>
              <div class="grow"></div>
            ...
            <div x-show="authed && activityRepos.length" class="grid gap-4 lg:grid-cols-3 items-start">
                  ...
                  <template x-for="r in activityRepos" :key="r.repo">
                    <div class="rounded-lg px-2 py-1.5 hover:bg-base-100 transition-colors min-w-0">
                      <div class="flex items-center gap-2 min-w-0">
                        ...
                        <span x-show="r.pushedAt" class="text-[10px] text-base-content/55 shrink-0 w-9 text-right tabular-nums"
                      ...
                      <div x-show="r.openPRs && r.openPRs.length" class="flex items-center gap-1 mt-0.5 pl-0.5 text-[10px] min-w-0">
                        <i class="ph ph-git-pull-request text-[10px] text-primary/70 shrink-0"></i>
              ...
              <div class="lg:col-span-1 min-w-0" :class="actSub!=='commits' && 'hidden lg:block'">
                <div class="hidden lg:block text-[10px] font-mono uppercase tracking-widest text-base-content/55 mb-2 px-1">Recent commits</div>
                  ...
                  <template x-for="c in activityStream.slice(0, 25)" :key="c.repo + c.sha">
                    <a :href="commitUrl(c.repo, c.sha)" target="_blank"
                      ...
                      <div class="flex items-baseline gap-1.5 min-w-0">
                        ...
                        <span class="text-[10px] text-base-content/55 shrink-0 tabular-nums" x-text="agoShort(c.date)"></span>
                      </div>
                      <span class="text-[10px] font-mono text-base-content/60 truncate block" x-text="repoShort(c.repo)"></span>
                    </a>
                  </template>
                </div>
              </div>
