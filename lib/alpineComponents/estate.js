    ...
    return {
      ...
      get tableColumns(){
        ...
        return [
          ...
          { ...text('Name', 'title', 220), dflt: true },
          { ...dateCol, dflt: true },
          { ...this.NUM_FILTER, title: 'Ran', field: 'mins', sorter: 'number', width: 84,
            formatter: (c) => '<span class="tabular-nums">' + this.durUnit(c.getValue()) + '</span>',
            dflt: true },
      ...
      async mountTable(){
        ...
        this.tabulator = new window.Tabulator(host, {
          ...
          // than in a column.
          layout: 'fitDataFill',
          // 36, not 44: the content is one line of 16px text, so 44 spent ten
          // pixels of air above and below every row and cost four rows a screen.
          rowHeight: 36,
