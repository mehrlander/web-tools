                  ...
                  <div class="card bg-base-100 border border-base-300 shadow-sm hover:border-primary/40 transition-colors
                    ...
                    <div class="card-body p-4 gap-1.5">
                      <div class="flex items-center gap-1.5">
                        ...
                        <i x-show="!e.child && e.meta" class="ph text-base sm:text-sm leading-none shrink-0 text-base-content/40"
                        ...
                        <a :href="'https://github.com/' + face(e).repo" target="_blank" @click.stop
                           ...
                           title="Open on GitHub"><i class="ph ph-github-logo text-base sm:text-sm leading-none relative -top-px"></i></a>
                      </div>
