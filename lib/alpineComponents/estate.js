document.addEventListener('alpine:init', function() {
  ...
  Alpine.data('estate', function() {
    ...
    const ACTIVITY_TABS = ['activity', 'sessions', 'writes', 'chats', 'routes', 'state'];
      ...
      template: `
        <div :class="tab==='lists' && 'flex-1 min-h-0 flex flex-col'">
          ...
          <div class="flex-1 min-w-0" :class="tab==='routes' ? '' : 'hidden'"
            ...
            <div x-show="authed && routeRows.length"
                 class="flex flex-col divide-y divide-[var(--color-base-300)]/50 border-y border-base-300/50 mb-4">
