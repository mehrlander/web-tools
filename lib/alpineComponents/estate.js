      ...
      template: `
        <div :class="tab==='lists' && 'flex-1 min-h-0 flex flex-col'">
          ...
          <div x-show="isActivityTab"
            ...
            <!-- The query and State travel as ONE flex item. As two, the box
                 could take the last room on the pills' line and leave State
                 alone on a line of its own, seen on a 428 px phone. Grouped,
                 they share the pills' line where both fit and wrap together
                 where they do not. -->
            <div class="flex items-center gap-2 grow basis-44 min-w-0">
              <label class="input input-sm flex items-center gap-1.5 grow basis-28 min-w-0 max-w-md">
