      ...
      template: `
        <div class="@container flex flex-col gap-4" data-installation>
          <div class="flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            <!-- The work machine names this view, not the word "Installation".
                 That was the pill's label, and when the view became a
                 workspace's Overview (2026-09-14) the label became a heading
                 over the whole front page, naming the manifest it reads rather
                 than the machine the page is about. The breadcrumb above
                 already says which workspace this is. -->
