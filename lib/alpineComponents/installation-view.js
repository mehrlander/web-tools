...
document.addEventListener('alpine:init', function () {
  Alpine.data('installationView', function (project) {
    ...
    return {
            ...
            <div class="min-w-0" :class="selected ? 'block' : 'hidden @3xl:block'">
              ...
              <template x-if="item">
                <div class="flex flex-col gap-4"
                  ...
                  <!-- The placement flow and the ways out. What acts on the text
                       itself (copy, download, compare) sits on the Source header. -->
                  ...
                  <!-- The source at the captured revision, read-only: the Code
                       ...
                       collapsed and Record installed stays above the fold. A
                  ...
                  <div class="flex flex-col gap-1.5" data-source>
                    <div class="flex flex-wrap items-center gap-x-1 gap-y-1 text-sm font-medium text-base-content/60">
                      <span>Source</span>
                      <span x-show="sourceState === 'loading'" class="loading loading-dots loading-xs opacity-50 ml-1"></span>
                      <div class="grow"></div>
                    ...
                    <div :class="sourceOpen ? 'block' : 'hidden @3xl:block'" data-source-body>
                      ...
                      <div :class="[sourceState === 'loading' || sourceState === 'editor' ? '' : 'hidden', dropRing]" data-source-editor
                           class="h-96 @3xl:h-[32rem] rounded-lg border overflow-hidden text-sm"></div>
                      <pre :class="[sourceState === 'plain' ? '' : 'hidden', dropRing]" data-source-plain
      ...
      get dropRing() { return this.dragging ? 'border-primary ring-2 ring-primary/40' : 'border-base-300'; },
