...
const BOOT = [
  ...
  // The second opinion for a branch that declares nobody. Beside the marks
  // rather than lazily loaded, because it is read at render time from the same
  // row, so a late load would leave the slot blank on first paint.
  { path: 'kits/assistant-guess.js' },
