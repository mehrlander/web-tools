(() => {
  ...
  const QUERIES = {
    ...
    // not one. Measured 2026-09-09: web-tools had 579 branches and home 644
    // against a 500 cap, so 79 and 144 were dropped by name. Branch names here
    // are `claude/<slug>-<hash>`, so alphabetical is arbitrary with respect to
    // age; the oldest and most stranded work was as likely to be cut as
    // anything else.
    //
