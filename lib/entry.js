...
// The ref is the page's ?use=<branch|tag|sha>, else main. A page whose own
// ?use= means something else (a toss of another repo sets it to that repo's
// ref) pins this one on the import instead: entry.js?ref=<ref> wins.
//
