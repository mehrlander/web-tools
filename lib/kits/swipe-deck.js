...
(() => {
  ...
  function open(o = {}) {
    ...
    // not responsive. The split between stating and measuring follows which of
    ...
    const menu = (btn, rows, o2 = {}) => {
      ...
      // widths the room beside a mark usually exceeds the menu's width, so it
      // flips every time and still opens well to the LEFT of its mark.
      //
