...
(() => {
  ...
  // A top-level `root.<name> =` is the shelf's namespace shape (tools/build/kits-index.mjs).
  const root = typeof window !== 'undefined' ? window : globalThis;
  root.GitChange = exported;
  if (root !== globalThis) globalThis.GitChange = exported;
