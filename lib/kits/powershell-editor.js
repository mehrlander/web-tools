...
(() => {
  ...
  async function create(host, opts = {}) {
    ...
    editor.getWrapperElement().classList.add('!bg-base-100', '!text-base-content', '!text-base', '!font-mono',
      '[&_.cm-keyword]:!text-[color-mix(in_oklab,var(--color-secondary),var(--color-base-content)_70%)]',
      '[&_.cm-atom]:!text-[color-mix(in_oklab,var(--color-accent),var(--color-base-content)_70%)]',
      '[&_.cm-number]:!text-[color-mix(in_oklab,var(--color-accent),var(--color-base-content)_70%)]',
      '[&_.cm-def]:!text-[color-mix(in_oklab,var(--color-primary),var(--color-base-content)_70%)]',
      '[&_.cm-builtin]:!text-[color-mix(in_oklab,var(--color-accent),var(--color-base-content)_70%)]',
      '[&_.cm-variable-2]:!text-[color-mix(in_oklab,var(--color-info),var(--color-base-content)_70%)]',
      '[&_.cm-string]:!text-[color-mix(in_oklab,var(--color-success),var(--color-base-content)_70%)]',
      '[&_.cm-comment]:!text-base-content/80',
      '[&_.cm-tag]:!text-[color-mix(in_oklab,var(--color-primary),var(--color-base-content)_70%)]',
      '[&_.cm-attribute]:!text-[color-mix(in_oklab,var(--color-secondary),var(--color-base-content)_70%)]');
