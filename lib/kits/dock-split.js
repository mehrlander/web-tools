...
.dk-split::before{content:"";flex:none;border-radius:999px;
...
/* Centred on the seam is the default. The after option remains for a caller
   whose own frame cannot let the readout straddle its edge; swipe-deck no longer
   needs it because its seam is a sibling of the clipping overlay. (No backticks
   in here: this comment lives INSIDE a template literal, and a stray pair ends
   the string and turns the rest of the stylesheet into JavaScript.) */
