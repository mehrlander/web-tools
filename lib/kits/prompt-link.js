...
// checkout's session-*.sh (docs/environment/extending.md), and DISPATCH is the
// phone-to-desktop relay in docs/venues.md. Neither has anything to do with this. `StageLink` is
