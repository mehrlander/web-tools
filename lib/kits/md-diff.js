...
(() => {
  ...
  async function render(host, oldMd, newMd, opts = {}) {
    ...
    const keys = (e) => {
      ...
      //
      // Gated on a claim, like the stops already were. A reader who has not
      // claimed anything still scrolls with these keys, which is what they
      // expect of a document; the floating strip's arrow is how you claim the
      // first one without a tap.
