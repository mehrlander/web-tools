...
// paragraph that became five flattened into five edges. Scored with the
// pairing rule below, git recovers the four edges that experiment called
// well-founded and declines the four it had warned against, so the file was
// retired and the walk replaced it. The pairing is a reading of the hunk, not
