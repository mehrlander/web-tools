...
// paragraphs: what each one used to say, and what was proposed along the way.
//
...
(() => {
  ...
  // Every text id that some revision leads into, keyed by flattened text.
  ...
  function table(index) {
    ...
    for (const r of index.revisions || []) {
      const key = flat(index.texts?.[r.to]);
