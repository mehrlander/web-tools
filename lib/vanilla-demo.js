...
(() => {
  ...
  function buildDisplayControl(mount) {
    const wrap = h('div', { class: 'fixed top-3 right-6 z-50 pointer-events-auto' });
    ...
    const pop = h('div', { class: 'absolute left-0 bottom-full mb-1 z-50 w-52 rounded-box bg-base-100 border border-base-300 shadow-lg p-3 hidden' });
