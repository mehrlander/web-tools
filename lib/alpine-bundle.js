(function() {
    const registerMagics = () => {
        Alpine.store('browser', {
            ...
            config: null,
            // Which filename config was loaded from ('.web-tools.json', the
            // legacy '.show-repo.json', or null when unconfigured). The config
            // editor reads it to know whether a save is a migration.
            configName: null,
