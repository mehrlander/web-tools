...
- 🎫 [Separate authored from derived data across the registries](tasks/registry-authored-derived-split-v3qm2x.md) · L (awaiting: three decisions, all yours: sibling CSV or the subject's own file, per registry; suffix or folder for the naming; and whether this runs before or after budget-drs's column-primitive task)
