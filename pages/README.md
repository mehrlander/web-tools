...
| `json-lens` | JSON Lens · GitHub-Style Structural Explorer | [view](https://mehrlander.github.io/web-tools/pages/drop/json-lens.html) · [code](https://github.com/mehrlander/web-tools/blob/main/pages/drop/json-lens.html) |
