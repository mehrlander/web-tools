...
🥏 [pages/show-repo/show-repo.html](https://mehrlander.github.io/web-tools/pages/toss-render.html#gh=mehrlander/web-tools@3aafd23:pages/show-repo/show-repo.html)
...
- lib/alpineComponents/repo.js ([new](https://github.com/mehrlander/web-tools/blob/claude/show-repo-pages-integration-uzn9gw/lib/alpineComponents/repo.js), [main](https://github.com/mehrlander/web-tools/blob/main/lib/alpineComponents/repo.js)) -- inline mode, icon underline fix, uniform text size
