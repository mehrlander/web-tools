...
function render(reg, owners) {
  ...
  lines.push('live in [the Web Tools app\'s Map → Docs → Inventory](https://mehrlander.github.io/web-tools/app/?view=map&tab=docs).');
  lines.push('A **record** preserves a moment and is');
